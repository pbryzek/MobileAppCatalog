windowFunctions['Create User'] = function (evt) {
    ...
    var fields = [ username, password, confirmPassword, firstName, lastName, emailAddress ];
    ...
    function submitForm() {
        ...
        Cloud.Users.create({
            ...
            if (e.success) {
                ...
                emailAddress.value = username.value = password.value = confirmPassword.value = firstName.value = lastName.value = '';
            }
            else {
                error(e);
            }
